...
namespace precise {
    ...
    static UNITS_CPP14_CONSTEXPR_OBJECT std::array<unitD, 2188> r20_units = {{
        ...
        unitD{"DW", "Calendar days", {1.0, day}},
        ...
        unitD{"FK", "fibers", {1.0, count, commodities::fiber}},
        ...
        unitD{"HTZ", "hertz", Hz},
        unitD{"HUR", "hour", hr},
        unitD{"HV", "hundred weight (short)", av::hundredweight},
        ...
        unitD{"IS", "stops", {1.0, count, commodities::stops}},
        unitD{
            "ISD",
        ...
        unitD{"N7", "parts", {1.0, count, commodities::packaging::parts}},
        ...
        unitD{"R8", "Roentgen equivalent in Man (REM)", cgs::REM},
        ...
        unitD{
            "TY",
            "tank, cylindrical",
            {1.0, count, commodities::packaging::cylindrical_tank}},
        ...
        unitD{"U5", "Two hundred and fifty", {250.0, count}},
        ...
        unitD{"UP", "Trouche", {1.0, count, commodities::packaging::trouche}},
