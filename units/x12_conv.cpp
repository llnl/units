...
static UNITS_CPP14_CONSTEXPR_OBJECT std::array<unitD, 812> x12_units{{
            ...
            unitD{"17", "100 POUND DRUM", {100.0, lb, commodities::packaging::drum}},
            unitD{"18", "55 GALLON DRUM", {55.0, us::gallon, commodities::packaging::drum}},
    ...
    unitD{"2G", "volt_ac", V},
    unitD{"2H", "volt_dc", V},
    unitD{"2I", "BRITISH THERMAL UNITS/HOUR", precise::energy::btu_it / precise::hr},
   ...
   unitD{
                ...
                mL / (cm.pow(2) * s)},
   unitD{"36", "Cubic Feet per Minute per Square Foot", ft.pow(3) / minute/ft.pow(2)},
   ...
   unitD{
    ...
    unitD{"44", "500 KILOGRAM BULK BAG", {500.0, kg, commodities::packaging::bulk_bag}},
    unitD{"45", "300 KILOGRAM BULK BAG", {300.0, kg, commodities::packaging::bulk_bag}},
    unitD{"46", "25 KILOGRAM BULK BAG", {25.0, kg, commodities::packaging::bulk_bag}},
    unitD{"47", "50 POUND BAG", {50.0, lb, commodities::packaging::bag}},
    unitD{"48", "BULK CAR LOAD", {1.0, count, commodities::packaging::bulk_car}},
    ...
    unitD{"58", "NET KILOGRAMS",{1.0, kg, commodities::packaging::net_quantity}},
...
unitD{
    ...
    unitD{"9Z", "united states pharmacopoeia unit", precise::generate_custom_unit(43)},
    unitD{"A8", "dollar per hour", currency / hr},
    unitD{ "AA", "BALL", {1.0, count, commodities::packaging::ball} },
    unitD{"AB", "BULK PACK", {1.0, count, commodities::packaging::bulk_pack}},
    unitD{"AC", "ACRE", acre},
    ...
    unitD{"AS", "ASSORTMENT", {1.0, count, commodities::packaging::assortment}},
    unitD{"AT", "ATMOSPHERE", pressure::atm},
    unitD{"AU","ocular insert system",{1.0,count,commodities::packaging::ocular_insert_system}},
    unitD{ "AV", "CAPSULE", {1.0, count, commodities::packaging::capsule} },
    unitD{"AW", "POWDER-FILLED VIAL",{1.0, count, commodities::packaging::powder_vial}},
    ...
    unitD{"C9", "COIL GROUP", {1.0, count, commodities::packaging::coil_group}},
    ...
    unitD{"CH", "CONTAINER", {1.0, count, commodities::packaging::container}},
    unitD{"CI", "CUBIC INCH", precise::in.pow(3)},
    unitD{"CJ", "CONE", {1.0, count, commodities::packaging::cone}},
    unitD{"CK", "CONNECTOR", {1.0, count, commodities::packaging::connector}},
    ...
    unitD{"CQ", "CARTRIDGE", {1.0, count, commodities::packaging::cartridge}},
    ...
    unitD{"DI", "DISPENSER", {1.0, count, commodities::packaging::dispenser}},
    ...
    unitD{"DO", "DOLLARS U.S.",{1.0,currency,commodities::currencies::dollar} },
    ...
    unitD{"DY", "DIRECTORY BOOKS",  {1.0, count, commodities::packaging::book}},
    ...
    unitD{
        ...
        unitD{"E7","inches decimal-average",{1.0,in,commodities::packaging::average}},
        unitD{"E8","inches decimal-actual",{1.0,in,commodities::packaging::actual}},
        unitD{"E9","english feet and inches",{1.0,imp::foot}}, 
    unitD{"EA", "EACH", precise::count},
    unitD{"EB", "ELECTRONIC MAIL BOXES", {1.0, count, commodities::electronic_mail_box}},
    unitD{"EC", "each per month", count / time::moj},
    unitD{"ED","inches decimal-nominal",{1.0,in,commodities::packaging::nominal}},
    unitD{"EE", "EMPLOYEES",  {1.0, count, commodities::employee}},
    unitD{"EF","inches fraction-nominal",{1.0,in,commodities::packaging::nominal}},
    unitD{
        "EG",
        "double time hours",
        {1.0, hr, commodities::doubletime}},
    unitD{"EH", "KNOTS", precise::nautical::knot},
    unitD{"EJ", "LOCATIONS",  {1.0, count, commodities::locations}},
    unitD{"EM","inches decimal-minimum",{1.0,in,commodities::packaging::minimum}},
    unitD{ "EP", "ELEVEN PACK", {11, precise::count} },
    unitD{"EQ", "EQUIVALENT GALLONS", {1.0,gal,commodities::packaging::equivalent} },
    ...
    unitD{"F6", "PRICE PER SHARE", currency/precise_unit(1.0, count, commodities::generateShareCode("     "))},
    ...
    unitD{"FG", "TRANSDERMAL PATCH", {1.0, count, commodities::packaging::patch}},
    ...
    unitD{"GT","Gross kilogram",{1.0,kg,commodities::packaging::gross_quantity}},
    ...
    unitD{"HB", "HUNDRED BOXES", {100.0, count, commodities::packaging::box}},
    ...
    unitD{"HI", "HUNDRED SHEETS", {100.0, count, commodities::packaging::sheet}},
    ...
    unitD{"HV", "HUNDRED WEIGHT - SHORT (HUNDRED WEIGHT)", av::hundredweight},
    ...
    unitD{"IW", "INCHES PER SECOND SQUARED (vibration acceleration)", in / s.pow(2)},
    ...
    unitD{"LJ", "LARGE SPRAY", {1.0, count, commodities::packaging::large_spray}},
    ...
    unitD{"MN", "METRIC NET TON", {1.0, mass::tonne, commodities::packaging::net_quantity}},
    ...
    unitD{"N2", "NUMBER OF LINES",  {1.0, count, commodities::linesofservice}},
    ...
    unitD{"N9", "CARTRIDGE NEEDLE", {1.0, count, commodities::cartridge_needle}},
    ...
    unitD{"OG", "APOTHECARY GRAIN", precise_unit(1.0/5760.0,precise::apothecaries::pound)},
    ...
    unitD{"P0", "PAGE - ELECTRONIC", {1.0, count, commodities::packaging::page_electronic}},
    ...
    unitD{"PF", "PALLET (LIFT)", {1.0, count, commodities::packaging::pallet}},
    ...
    unitD{"PJ","pounds, Decimal - Pounds per square foot - Pound gage",pressure::psig},
    unitD{"PK", "PACKAGE", {1.0, count, commodities::packaging::pack}},
    unitD{"PL", "PALLET/UNIT LOAD", {1.0, count, commodities::packaging::pallet}},
    ...
    unitD{"R5", "THOUSANDS OF DOLLARS", {1000.0,currency,commodities::currencies::dollar}},
        unitD{ "R6","millions of dollar",{1000000.0,currency,commodities::currencies::dollar} },
        unitD{ "R7","billions of dollar",{1000000000.0,currency,commodities::currencies::dollar} },
    ...
    unitD{"RK", "ROLL-METRIC MEASURE", {1.0, count, commodities::packaging::roll}},
    ...
    unitD{"S7", "STORAGE UNITS", {1.0, count, commodities::packaging::storage_unit}},
    unitD{"S8", "STANDARD ADVERTISING UNIT", generate_custom_unit(380)},
    unitD{"S9", "SLIP SHEET", {1.0, count, commodities::packaging::slipsheet}},
    unitD{"SA", "SANDWICH",  {1.0,
    count,
    ...
    unitD{"SK", "SPLIT TANKTRUCK", {1.0, count, commodities::packaging::split_tank_truck}},
    ...
    unitD{"SP", "SHELF PACKAGE", {1.0, count, commodities::packaging::shelf_package}},
    unitD{"SQ", "SQUARE", {1.0, count, commodities::packaging::square}},
    unitD{"SR", "STRIP", {1.0, count, commodities::packaging::strip}},
    unitD{"SS", "SHEET-METRIC MEASURE", {1.0, count, commodities::packaging::sheet}},
    ...
    unitD{"T3", "THOUSAND PIECES", {1000.0, count, commodities::packaging::piece}},
    unitD{"T4", "THOUSAND BAGS",  {1000.0, count, commodities::packaging::bag}},
    unitD{"T5", "THOUSAND CASINGS", {1000.0, count, commodities::packaging::casing}},
    unitD{"T6", "THOUSAND GALLONS", thousand* us::gallon},
    unitD{"T7", "THOUSAND IMPRESSIONS", {1000.0, count, commodities::impression}},
    ...
    unitD{"TW", "THOUSAND SHEETS",precise_unit(1.0, thousand, commodities::packaging::sheet)},
    ...
    unitD{"U1", "TREATMENT",  {1.0, count, commodities::packaging::treatment}},
   ...
   unitD{ "UW","milliequivalent",{0.001,one,commodities::packaging::equivalent} },
    ...
    unitD{"V2", "POUCH",  precise_unit(count, commodities::packaging::pouch)},
    ...
    unitD{"YL", "100 LINEAR YARDS", {100.0, yd, commodities::packaging::linear}},
    unitD{"YR", "YEAR", yr},
    unitD{"Z1", "LIFT VAN",  {1.0,count, commodities::packaging::lift_van} },
    unitD{"Z2", "CHEST", precise_unit(count, commodities::packaging::chest)},
