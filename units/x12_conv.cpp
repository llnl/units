...
static UNITS_CPP14_CONSTEXPR_OBJECT std::array<unitD, 595> x12_units{{
...
static UNITS_CPP14_CONSTEXPR_OBJECT std::array<unitD, 496> dod_units = {{
    unitD{"05", "LIFT", {1.0, count, commodities::packaging::lift}},
    unitD{"07", "STRAND", precise::one},
    unitD{"09", "TIRE", precise::one},
